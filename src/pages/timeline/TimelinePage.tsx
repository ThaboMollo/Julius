  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="bg-white rounded-xl p-4 shadow">
        <h1 className="text-lg font-semibold text-gray-800">Timeline</h1>
                ...
                <div className="w-20 text-center flex-shrink-0">
                  <div
                    className={`text-2xl font-bold ${
                      isPayday ? 'text-green-600' : 'text-gray-800'
                    }`}
                  >
                    {format(event.date, 'd')}
                  </div>
                  <div className="text-xs text-gray-500">{format(event.date, 'EEE')}</div>
                </div>

                {/* Divider */}
                <div
                  className={`w-1 h-12 rounded ${
                    isPayday ? 'bg-green-500' : 'bg-red-400'
                  }`}
                />
